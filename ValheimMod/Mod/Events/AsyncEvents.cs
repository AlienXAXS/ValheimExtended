...
namespace Mod.Events
{
    ...
    internal static class EventExtensions
    {
        ...
        public static async Task InvokeAsync<T>(this AsyncEvent<Func<T, Task>> eventHandler, T arg)
        {
            var subscribers = eventHandler.Subscriptions;
            foreach (var subscriber in subscribers)
                await subscriber.Invoke(arg).ConfigureAwait(false);
        }
        ...
        public static async Task InvokeAsync<T1, T2>(this AsyncEvent<Func<T1, T2, Task>> eventHandler, T1 arg1, T2 arg2)
        {
            var subscribers = eventHandler.Subscriptions;
            foreach (var subscriber in subscribers)
                await subscriber.Invoke(arg1, arg2).ConfigureAwait(false);
        }
            ...
            T2 arg2, T3 arg3)
        {
            var subscribers = eventHandler.Subscriptions;
            foreach (var subscriber in subscribers)
                await subscriber.Invoke(arg1, arg2, arg3).ConfigureAwait(false);
        }
            ...
            T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
            var subscribers = eventHandler.Subscriptions;
            foreach (var subscriber in subscribers)
                await subscriber.Invoke(arg1, arg2, arg3, arg4).ConfigureAwait(false);
        }
            ...
            this AsyncEvent<Func<T1, T2, T3, T4, T5, Task>> eventHandler, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
        {
            var subscribers = eventHandler.Subscriptions;
            foreach (var subscriber in subscribers)
                await subscriber.Invoke(arg1, arg2, arg3, arg4, arg5).ConfigureAwait(false);
        }
    }
}
